...
//    private boolean show_timings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // coor = (EditText)findViewById(R.id.cood);
        graphView = findViewById(R.id.heartgraph);
...
//        }
       // times = String.valueOf(b).split("=");

        // CREATE A DATABASE
        db = openOrCreateDatabase("plots",MODE_PRIVATE,null);// CREATING A TABLE
        //db.execSQL("CREATE TABLE IF NOT EXISTS xy(id INTEGER PRIMARY KEY AUTOINCREMENT, x INTEGER, y INTEGER,z INTEGER);");
    ...
    public void plots() {
        // TRY TO READ ALL THE POINTS
            ...
            if (count > 0) {
                ...
                series.resetData(dp);
//                Toast.makeText(this,"plot inserted"+r.getInt(0)+r.getInt(1),Toast.LENGTH_LONG).show();
